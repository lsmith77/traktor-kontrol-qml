...
**Purpose**: Index and reading guide for the root-level handbook docs
...
6. [05_FAQ.md](05_FAQ.md) — Frequently asked questions
...
- If a change doesn't work, go to [04_TROUBLESHOOTING.md](04_TROUBLESHOOTING.md)- For common questions, check [05_FAQ.md](05_FAQ.md)- If anything breaks after a Traktor update, go to [06_COMPATIBILITY_FIXES.md](06_COMPATIBILITY_FIXES.md)
