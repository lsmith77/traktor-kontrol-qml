...
1. Run Traktor from Terminal and capture the output (see [04_TROUBLESHOOTING.md](../handbook/04_TROUBLESHOOTING.md#1-run-traktor-from-terminal-and-check-startup-errors))
