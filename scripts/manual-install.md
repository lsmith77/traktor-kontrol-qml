...
[traktor-logger](https://github.com/lsmith77/traktor-logger) adds real-time logging and a browser dashboard. For full manual installation instructions — including how to copy the required QML files and enable metadata collection — see the [traktor-logger Manual Installation guide](../traktor-logger/README.md#manual-installation-without-traktor-mod).
